...
/// The iOS implementation of [MediaKeyDetectorPlatform].
class MediaKeyDetectorIOS extends MediaKeyDetectorPlatform {
  final _eventChannel = const EventChannel('media_key_detector_ios_events');

  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('media_key_detector_ios');

  /// Registers this class as the default instance of [MediaKeyDetectorPlatform]
  static void registerWith() {
    MediaKeyDetectorPlatform.instance = MediaKeyDetectorIOS();
  }
  ...
  Future<void> setIsPlaying({required bool isPlaying}) {
    return methodChannel.invokeMethod<String>('setIsPlaying', <String, dynamic>{'isPlaying': isPlaying});
  }
}
