...
- Android: simulate additional actions for local connection method (Left, Down, Right, Up, Select, Back, Home, Recent Apps), allowing you to navigate in the trainer app, if supported
