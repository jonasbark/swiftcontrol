        ...
        socket.listen(
          (List<int> data) {
            ...
            while (mutable.isNotEmpty) {
              ...
              switch (msgId) {
                case MdnsConstants.DC_MESSAGE_DISCOVER_SERVICES:
                  final body = hexToBytes(ZwiftConstants.ZWIFT_RIDE_CUSTOM_SERVICE_UUID.toNonDash());

                  final header = buildHeader(MdnsConstants.DC_RC_REQUEST_COMPLETED_SUCCESSFULLY, body.length);
                ...
                case MdnsConstants.DC_MESSAGE_WRITE_CHARACTERISTIC:
                  ...
                  return;
                case MdnsConstants.DC_MESSAGE_ENABLE_CHARACTERISTIC_NOTIFICATIONS:
                  final rawUUID = body.takeBytes(16);
                  final characteristicUUID = bytesToHex(rawUUID).toUUID();
